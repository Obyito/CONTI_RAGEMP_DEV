...
namespace reallife.Blips
{
    public class RentCar : Script
    {
        public RentCar()
        {
            ...
            NAPI.Blip.SetBlipName(RENTSP, "Agence de location"); NAPI.Blip.SetBlipShortRange(RENTSP, true);
            ...
            NAPI.TextLabel.CreateTextLabel("Ici vous pouvez louer des véhicules appuyez sur ~b~E~w~ un scooter\npour ~g~150$~w~ Louez !", new Vector3(-1153.755, -718.8862, 20.97753), 12, 1f, 4, new Color(255, 255, 255, 255));
