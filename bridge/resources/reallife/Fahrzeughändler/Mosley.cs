...
namespace reallife.Fahrzeughändler
{
    public class Mosley : Script //244.6719
    {
        public Mosley()
        {
            ...
            NAPI.TextLabel.CreateTextLabel("Mosley Auto \n==>Pour ouvrir le menu appuyez sur ~g~E~w~<==", new Vector3(-40.82757, -1674.866, 29.5), 12, 1f, 4, new Color(255, 255, 255, 255));
        ...
        public void OnPlayerBuyVehicle2(Client client)
        {
            ...
            {
                client.SendChatMessage("Vous avez déjà trop de véhicules!");
                return;
            }
            ...
            {
                client.SendChatMessage("[~y~Autohaus~w~] Vous n'avez pas assez d'argent sur vous !");
            }
        }
        ...
        public void OnPlayerBuyVehicle1(Client client)
        {
            ...
            if (client.HasData("PersonalVehicle"))
            {
                client.SendChatMessage("Trop de véhicules !");
                return;
            }
            ...
            {
                client.SendChatMessage("[~y~Autohaus~w~] Pas assez d'argent sur vous !");
            }
        }
